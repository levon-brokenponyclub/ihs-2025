...
// StickyMiniCTA removed as unused, but keeping structure if needed for context
/*
const StickyMiniCTA = ({
    course,
    visible,
        ...
        <div className="flex flex-wrap justify-center gap-6 items-center">
            {accreditations.map((acc, idx) => {
                ...
                if (acc === 'IHS' || acc === 'International Hotel School') {
                    ...
                    src = '/assets/logos/american-hotel-lodging-educational-institute-r6djf1a4jfs1u9sokoij74ckub80bbe63d3o4wvozc.png';
                }
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div className="space-y-0.5">
                                    <p className="text-sm font-bold text-white">{(course.startDate || course.intake)?.split(',')[0]}</p>
                            ...
                            <div className="overflow-hidden pb-1">
                                <div className={`flex items-center gap-4 ${contentReady ? 'hero-enter animation-delay-850' : 'translate-y-[110%] opacity-0'}`}>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col">
                                            <p className="text-white font-semibold">{(course.startDate || course.intake)?.split(',')[0]}</p>
                                            {/* {(course.startDate || course.intake)?.includes(',') && (
                                                <p className="text-white/50 text-[10px] italic leading-tight mt-0.5">
                                                    Upcoming: {(course.startDate || course.intake)?.split(',').slice(1).join(', ')}
                                                </p>
