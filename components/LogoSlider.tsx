                     ...
                     {displayPartners.map((partner, index) => (
                        ...
                        >
                           <img
                               src={partner.logo}
                               alt={partner.name}
                               className="w-full h-auto max-w-[155px] max-h-[80px] object-contain transition-all duration-300"
                               style={{
                                   transform: (partner as any).scale ? `scale(${(partner as any).scale})` : 'scale(1)',
                                   filter: (partner as any).isJpg ? 'invert(1) grayscale(100%)' : 'grayscale(100%) brightness(0) invert(1)',
                                   mixBlendMode: (partner as any).isJpg ? 'screen' : 'normal'
                               }}
                           />
                       </div>
                     ))}
