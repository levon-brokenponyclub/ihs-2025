      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-white text-sm leading-relaxed mb-8">
              Africa's leading hospitality management and culinary school. Part
              of Sommet Education - World Leader in Hospitality Education.
            </p>
              ...
              {[Facebook, Instagram, Twitter, Linkedin, Youtube].map(
                (Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="w-9 h-9 rounded-full bg-brand-dark/20 border border-white/5 flex items-center justify-center text-white hover:bg-brand-gold hover:text-brand-dark transition-all duration-300"
                  >
                    <Icon size={14} />
                  </a>
                )
          ...
          {/* Column 2: Programmes */}
          <div>
            <h4 className="text-brand-gold font-bold mb-6 font-serif">
              Programmes
            </h4>
            <ul className="space-y-3 text-white/40 text-sm">
              <li className="hover:text-brand-gold cursor-pointer transition-colors">
        ...
        <div className="mt-8 text-center md:text-left flex flex-col md:flex-row justify-between text-xs text-white items-center">
          ...
          <div className="flex items-center gap-6 mt-4 md:mt-0">
            ...
            <button
              onClick={toggleDebug}
              className={`flex items-center gap-1 transition-colors px-2 py-1 rounded-sm border ${
                debugMode
