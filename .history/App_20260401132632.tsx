...
// import AppleInspiration from './components/AppleInspiration'
            ...
            <div className="min-h-screen bg-brand-dark text-brand-text font-sans antialiased selection:bg-brand-gold selection:text-brand-dark">
              ...
              <main>
                <Routes>
                  ...
                  <Route
                    path="/programmes/:type"
                    element={<ProgrammeArchive />}
                  />
                  ...
                  />
                  <Route
                    path="/admissions/registrations-and-accreditations"
                    element={<RegistrationsAccreditations />}
                  />
